...
# deploy persistent volume (pv)
kubectl delete -f ./manifests/nfs/media.persistentvolume.yml
kubectl apply -f ./manifests/nfs/media.persistentvolume.yml
kubectl get pv
kubectl describe pv media-ssd

# create persistent volume claim (pvc)
kubectl delete -f ./manifests/nfs/media.persistentvolumeclaim.yml
kubectl apply -f ./manifests/nfs/media.persistentvolumeclaim.yml
kubectl get pvc -n media
...
kubectl apply -f ./manifests/nfs/media.ingress.yml
...
# debug
kubectl delete -f ./manifests/nfs/pvc-debugger.yml
kubectl apply -f ./manifests/nfs/pvc-debugger.yml
kubectl exec -it volume-debugger sh -n media

kubectl delete -f ./manifests/nfs/pvc-debugger2.yml
kubectl apply -f ./manifests/nfs/pvc-debugger2.yml
